...
## Modelo EGARCH-EVT | dois estágios{.smaller .build}
...
## Filtro EGARCH | fundamentos {.build}

- Modelo GARCH exponencial ou EGARCH de @Nelson1991 para retirar heterocedasticidade dos dados
- Resíduos padronizados podem ser tratados como _iid_
- EGARCH lida também com o efeito alavancagem
...
\begin{align}
	...
	VaR_\alpha^t=\;& \sigma_t\Phi^{-1}(\alpha)
\end{align}
$$
...
- Única distribuição **sem** memória, exponencial
    ...
    + Teste sobre o parâmetro que se igual a zero transforma em exponencial
