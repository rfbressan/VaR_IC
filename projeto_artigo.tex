...
\title{Modelagem semiparamétrica de retornos financeiros através da teoria do valor extremo\tnoteref{mytitlenote}}
...
Para este trabalho não necessitamos calcular a qual $MDA$ pertencem nossas distribuições, bastando saber que basicamente todas as distribuições contínuas de utilidade prática estão contidas em $MDA(H_\xi)$ para algum valor de $\xi$. \todo{Fonte?}
