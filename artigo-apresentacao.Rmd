...
p+annotate("text", x = c(1.2, 1.5, 2), y = c(-0.02, 0.05, -0.02), 
           label = c("VaR[alpha]", "alpha", "ES[alpha]"), parse = TRUE, size = 6)
```
...
p+annotate("text", x = c(1.5, 2, 1, 0), y = c(-0.02, 0.02, -0.02, 0.15), 
           label = c("VaR[alpha]", "alpha", "u", "Empírica"), parse = TRUE, size = 6)
```
